...
public class CV_SetPatternLockActivityChangePassword extends AppCompatActivity {
    Context cv_mContext;
    String cv_myfrom;
    ...
    private void cv_init() {
        ...
        this.cv_patternLockView.setOnPatternListener(new PatternLockView.OnPatternListener() {
            ...
            public boolean onComplete(ArrayList<Integer> arrayList) {
                boolean equals = TextUtils.equals(CV_SetPatternLockActivityChangePassword.this.cv_tinyDB.getString(CV_SetPatternLockActivityChangePassword.this.getResources().getString(R.string.pattern_password)), CV_SetPatternLockActivityChangePassword.this.getPatternString(arrayList));
                if ((!CV_SetPatternLockActivityChangePassword.this.cv_tinyDB.getString(CV_SetPatternLockActivityChangePassword.this.getResources().getString(R.string.pattern_password)).equalsIgnoreCase("") || !CV_SetPatternLockActivityChangePassword.this.cv_myfrom.equalsIgnoreCase("set")) && !CV_SetPatternLockActivityChangePassword.this.cv_myfrom.equalsIgnoreCase("change") && CV_SetPatternLockActivityChangePassword.this.cv_myfrom != null && !CV_SetPatternLockActivityChangePassword.this.cv_myfrom.isEmpty() && CV_SetPatternLockActivityChangePassword.this.cv_myfrom.equals("oldpasswordmatch")) {
                    CV_SetPatternLockActivityChangePassword.this.cv_tinyDB.putString(CV_SetPatternLockActivityChangePassword.this.getResources().getString(R.string.pattern_password), CV_SetPatternLockActivityChangePassword.this.getPatternString(arrayList));
                    CV_SetPatternLockActivityChangePassword.this.finish();
                }
                return equals;
            }
        });
